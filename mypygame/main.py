...
YELLOW_SPACESHIP_IMAGE = pygame.image.load(os.path.join('mypygame/Assets/yellowspaceship.png'))
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP_IMAGE,(55,40)),90)

RED_SPACESHIP_IMAGE = pygame.image.load(os.path.join('mypygame/Assets/redspaceship.png'))
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(RED_SPACESHIP_IMAGE,(55,40)),-90)

SPACE = pygame.transform.scale(pygame.image.load(os.path.join('mypygame/Assets/space.png')), (WIDTH, HEIGHT))
